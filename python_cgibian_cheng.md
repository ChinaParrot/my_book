...
[http://www.test.com/cgi-bin/hello.py?key1=value1&key2=value2](http://www.test.com/cgi-bin/hello.py?key1=value1&key2=value2) 有关 GET 请求的其他一些注释：
...
以下是一个通过HTML的表单使用GET方法向服务器发送两个数据，提交的服务器脚本同样是hello\_get.py文件，代码如下：
